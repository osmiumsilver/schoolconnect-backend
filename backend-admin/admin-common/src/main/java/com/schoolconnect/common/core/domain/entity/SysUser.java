...
public class SysUser extends BaseEntity
{
    ...
    @Xss(message = "用户账号不能包含脚本字符")@NotBlank(message = "用户账号不能为空")@Size(min = 0, max = 30, message = "用户账号长度不能超过30个字符")
    /** 用户账号 */
    @Excel(name = "登录名称")
    private String userName;

    @Xss(message = "用户昵称不能包含脚本字符")@Size(min = 0, max = 30, message = "用户昵称长度不能超过30个字符")
    /** 用户昵称 */
    @Excel(name = "用户名称")
