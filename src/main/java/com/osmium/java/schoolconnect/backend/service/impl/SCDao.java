...
public class SCDao extends BaseDao {
    ...
    public ArrayList<Grade> query_all_sc() {
        ...
        try (PreparedStatement ps = con.prepareStatement(sql)) {
            ...
            while (rs.next()) {
                Grade sc = new Grade(rs.getInt("sno"), rs.getString("sname"), rs.getString("ssex"), rs.getByte("sage"), rs.getInt("cno"), rs.getString("cname"), rs.getFloat("grade"));
